...
#Diccionaria para las etiquetas de las graficas
    ...
    def plot(self, dataframe, key):
        ...
        new_d=data[new_c]                      #   
        final=new_d.dropna()              #
          #Pertenece a las propiedades de la grafica 
        ga= self.etiqueta(llave=key)
        tools = ["pan", "box_zoom", "wheel_zoom", "save", "zoom_in", "zoom_out", "crosshair", "reset"]
    
        bp = figure(width=500, height=300, x_axis_type="datetime",x_axis_label="Tiempo (t)",y_axis_label=str(ga), toolbar_location='right',
