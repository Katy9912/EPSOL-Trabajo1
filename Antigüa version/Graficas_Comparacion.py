...
"")
        ...
        self.widget.setGeometry(QtCore.QRect(200, 80, 1040, 491))
        ...
        self.list_options = QtWidgets.QListWidget(self.centralwidget)
        self.list_options.setGeometry(QtCore.QRect(20, 140, 161, 411))
